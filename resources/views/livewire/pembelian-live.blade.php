...
<div>
  ...
  <form wire:submit.prevent="simpanData">
   ...
   <div class="lg:grid md:grid  lg:grid-cols-2  md:grid-cols-2 lg:gap 4  md:gap 4 pt-10" id="section-grid-utama">
      ...
      <div class="bg-white mt-5 pb-2 mb-5 lg:mx-5 md:mx-5 lg:mt-0 md:mt-0  shadow-lg  cursor-pointer rounded-lg border border-gray-200 p-4" id="section-detail-pembayaran">
